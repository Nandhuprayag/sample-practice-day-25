...
mydiv.style.width="1000px";mydiv.style.height="1900px";mydiv.style.flexWrap="wrap";
...
mycart.style.width="300px";mycart.style.height="500px";mycart.style.backgroundColor="#cddc39";
...
async function getdata()
{
    try {
         ...
         {
             var mycard=document.createElement('div');mycard.style.border="1px solid blue";
